...
from code.Constants import PLAYER_FRAME_DATA, ZOMBIE_FRAME_DATA, SPRITE_SCALE
...
class Animations:
    def __init__(self, entity_name: str):
        ...
        self.animations: dict[str, tuple] = PLAYER_FRAME_DATA if self.entity_name == "Player" else ZOMBIE_FRAME_DATA
